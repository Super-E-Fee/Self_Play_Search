...
from verl.trainer.ppo.ray_trainer_self_eff import RayPPOTrainer, ResourcePoolManager, Role
...
def _select_rm_score_fn(data_source):
    ...
    if data_source in impleted_list:
        return qa_em.compute_score_em #compute_score_bleu
    else:
...
def main_task(config):
    ...
    reward_fn = RewardManager(tokenizer=tokenizer, num_examine=0,format_score=0.1)
