...
class RayPPOTrainer(object):
    ...
    def external_reward_fn(self, data: DataProto, positive_mode=True, is_debug=False):
        ...
        for i in range(len(data)):
            ...
            score = qa_em.compute_score_em(solution_str=sequences_str, ground_truth=ground_truth, format_score=0.1,
                                         is_debug=(i<=10) and is_debug)
            
            # score = qa_em.compute_score_em(solution_str=sequences_str, ground_truth=ground_truth, 
                                        #  is_debug=(i<=10) and is_debug) # 
